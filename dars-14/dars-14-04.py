# -*- coding: utf-8 -*-
"""
Created on Tue Nov 12 08:21:45 2024
...
izohi=dictionary.get(kalit)
if izohi==None:print("Bunday so'z mavjud emas!")
else:print(f"{kalit.title()} so'zining tarjimasi '{izohi}'.")
